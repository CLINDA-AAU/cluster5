%latex.default(kld, file = "../Output/Tables/kld.tex", caption = "Kulback-Leibler divergence between the approximations and the simulated sampling distribution.",     label = "tab:kld", rowname = NULL, where = "tb")%
\begin{table}[tb]
