function likelihood=cluster5est2_Markov_func(beta,gamma,M,W)
...
Conditional=0; %Flag to control whether results are conditional (1) or joint probabilities (0) - to calculate observation likelihood
