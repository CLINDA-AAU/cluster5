...
Read epi data
```{r}
kom_cases <- read_csv2("../Data/Data-Epidemiologiske-Rapport-22012021-12jk/Municipality_cases_time_series.csv")
kom_test  <- read_csv2("../Data/Data-Epidemiologiske-Rapport-22012021-12jk/Municipality_tested_persons_time_series.csv")
kom_pos   <- read_csv2("../Data/Data-Epidemiologiske-Rapport-22012021-12jk/Municipality_test_pos.csv")

reg_test  <- read_csv2("../Data/Data-Epidemiologiske-Rapport-22012021-12jk/Test_regioner.csv")
```
